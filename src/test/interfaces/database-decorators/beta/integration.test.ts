...
import {
  Encrypted,
  EncryptionModifier,
} from "@ajs.local/database-decorators/beta/modifiers/encryption";
import {
  Hashed,
  HashModifier,
...
import {
  ...
  Localized,
} from "@ajs.local/database-decorators/beta/modifiers/localization";
import { RegisterTable } from "@ajs.local/database-decorators/beta/schema";
import {
  Fixture,
  Index,
  Table,
} from "@ajs.local/database-decorators/beta/table";
